...
WHERE (Item.ID = @ID)">
    ...
    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                ...
                <asp:CheckBox ID="CheckShowGridNoQR" runat="server" AutoPostBack="True" Checked="False" OnCheckedChanged="CheckShowGridNoQR_CheckedChanged"   />
                &nbsp;   <asp:Label ID="Label2" runat="server" Text=" แก้ไขสอบอุปกร์ที่ไม่มี QR Code"></asp:Label>
                <div style="margin-bottom: 30px;"></div>
                        <center>
                ...
                <asp:GridView ID="GridViewNoItem" runat="server" AutoGenerateColumns="False" DataKeyNames="CheckSheetDetailID" DataSourceID="SqlDataSourceNoItem" HorizontalAlign="Center" OnRowDataBound="OnRowDataBound" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="OK">
                            <ItemTemplate>
                                <asp:RadioButton ID="RadioButton1No" runat="server" value="1" Checked='<%# Bind("OK") %>' GroupName="MyGroup" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:CheckBoxField DataField="NG" HeaderText="NG" SortExpression="NG" Visible="False" />
                        <asp:TemplateField HeaderText="NG">
                            <ItemTemplate>
                                <asp:RadioButton ID="RadioButton2No" runat="server" value="0" Checked='<%# Bind("NG") %>' GroupName="MyGroup" />
                            </ItemTemplate>
                        </asp:TemplateField>
                         <asp:CheckBoxField DataField="NA" HeaderText="N/A" SortExpression="NA" Visible="False" />
                        <asp:TemplateField HeaderText="N/A">
                            <ItemTemplate>
                                <asp:RadioButton ID="RadioButton3No" runat="server" value="2" Checked='<%# Bind("NA") %>' GroupName="MyGroup" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField ShowHeader="False" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:Button ID="btnClear" class="btn btn-primary" OnClientClick="ClearNo(this);" runat="server" Text="Clear" />
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                    </Columns>
