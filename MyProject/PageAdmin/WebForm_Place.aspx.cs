...
{
    public partial class WebForm_Place : System.Web.UI.Page
    {
        ...
        {
            DropDownList4.Items.Insert(0, new ListItem("ALL FLOOR", "%"));
        }

        protected void DropDownList3_DataBound1(object sender, EventArgs e)
        {
            DropDownList3.Items.Insert(0, new ListItem("ALL Buildind", "%"));
        }
    }
}